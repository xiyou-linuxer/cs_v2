...
/***/ function(module, exports, __webpack_require__) {
	...
	var $messageShowPage = $('.koala-message-show-page');
	...
	$messageShowPage.find('#btn_message_delete').on('click', function (e) {
	  ...
	  _ui2.default.confirm('确定要删除该消息吗？').then(function () {
	    _message2.default.delete(id).then(function () {
	      _ui2.default.alert('消息删除成功~').then(function () {
	      ...
	      if (err && err.message) {
	        ...
	        _ui2.default.alert('消息删除失败，请稍后再试~');
	      }
	    });
	  });
	});
