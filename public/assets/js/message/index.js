...
/***/ function(module, exports, __webpack_require__) {
	...
	var _message = __webpack_require__(345);

	var _message2 = _interopRequireDefault(_message);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var $messageListPage = $('.koala-message-list-page');

	var $table = $messageListPage.find('table');
	var $messageBtns = $messageListPage.find('.message-group-btn');
	...
	$messageListPage.find('#btn_message_read').on('click', function () {
	  ...
	  var results = ids.map(function (id) {
	    return new Promise(function (resolve, reject) {
	      _message2.default.getById(id).then(function () {
	        deletedList.push(id);
	        resolve();
	      }).catch(function () {
	        failedList.push(id);
	  ...
	  Promise.all(results).then(function () {
	    _ui2.default.alert('批量标记信息成功~').then(function () {
	    ...
	    _ui2.default.alert('批量操作发生错误，部分或全部信息未成功标记~').then(function () {
	...
	$messageListPage.find('#btn_message_delete').on('click', function () {
	  ...
	  _ui2.default.confirm('确定要删除选定消息吗？').then(function () {
	    var ids = [];
	    var $rows = $table.find('tbody .checkbox:checked').parents('tr');
	    $rows.each(function () {
	      ids.push($(this).data('id'));
	    ...
	    var results = ids.map(function (id) {
	      return new Promise(function (resolve, reject) {
	        _message2.default.delete(id).then(function () {
	          deletedList.push(id);
	          resolve();
	        }).catch(function () {
	          failedList.push(id);
	    ...
	    Promise.all(results).then(function () {
	      _ui2.default.alert('批量删除成功~').then(function () {
	        setTimeout(function () {
	          $rows.remove();
	      ...
	      _ui2.default.alert('批量操作发生错误，部分或全部信息未成功删除~').then(function () {
	        deletedList.forEach(function (id) {
	          var $row = $('table tbody tr[data-id="' + id + '"]');
	          setTimeout(function () {
	            $row.remove();
