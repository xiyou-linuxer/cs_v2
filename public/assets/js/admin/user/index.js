...
/***/ function(module, exports, __webpack_require__) {
	...
	var $adminUserListPage = $('.koala-admin-user-list-page');
	...
	$adminUserListPage.find('table tbody .btn-delete').on('click', function (e) {
	  ...
	  _ui2.default.confirm('确定删除该用户吗？').then(function () {
	    _user2.default.delete(id).then(function () {
	      _ui2.default.alert({
	        message: '用户删除成功~'
	      }).then(function () {
	        $row.remove();
	      ...
	      if (err && err.message) {
	        ...
	        _ui2.default.alert('用户删除失败，请稍后再试~');
	      }
	    });
	  });
	});
	...
	$adminUserListPage.find('table tbody .btn-set-admin').on('click', function (e) {
	  ...
	  _ui2.default.confirm('设置为管理员之后，该用户将拥有极高的权限！<br>是否继续？').then(function () {
	    _user2.default.update(userId, { group: 1 }).then(function () {
	      _ui2.default.alert({
	        message: '操作成功~'
	      }).then(function () {
	...
	$adminUserListPage.find('table tbody .btn-unset-admin').on('click', function (e) {
	  ...
	  _ui2.default.confirm('取消管理员之后，该用户将不再具有任何系统管理权限！<br>是否继续？').then(function () {
	    _user2.default.update(userId, { group: 0 }).then(function () {
	      _ui2.default.alert({
	        message: '操作成功~'
	      }).then(function () {
	        window.location.href = '/admin/users';
