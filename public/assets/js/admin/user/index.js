...
define(['ui', '../../apis/user', 'jquery.serializeObject'], function (require, exports, module) {
  ...
  $('#user_select_form .form-control').on('change', function (e) {
  ...
  $('table tbody .btn-set-admin').on('click', function (e) {
    var userId = $(this).data('id');

    UI.confirm('设置为管理员之后，该用户将拥有极高的权限！<br>是否继续？').then(function () {
  ...
  $('table tbody .btn-unset-admin').on('click', function (e) {
    var userId = $(this).data('id');

    UI.confirm('取消管理员之后，该用户将不再具有任何系统管理权限！<br>是否继续？').then(function () {
